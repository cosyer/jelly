...
Jx().$package(function(J) {
  ...
  baseSoundPrototype =
     ...
     */
    {
      ...
      _correctVolume: function() {
        this._setDirectVolume(
          (this._volume *
            J.sound.Global._volume *
            !this._boolMute *
            !J.sound.Global._boolMute) /
            100
        );
      },
      ...
      init: function(url, autoLoadAndPlay, needEventSupport) {
        ...
        if (autoLoadAndPlay) {
          ...
          this._onloadCallback = function() {
            context.play();
            context._obj.removeEventListener(
              "canplay",
              context._onloadCallback,
              false
            );
  ...
  swfSound =
     ...
     */
    {
      ...
      load: function(url) {
        ...
        this._fid = obj.loadSound(
          this._url,
          this._needEventSupport ? this._id : -1,
          false
        );
        this._correctVolume();
      },
  ...
  embedSWF = function(path) {
    ...
    try {
      J.swfobject.embedSWF(
        path,
        "swfSound_Flash_div",
        "1",
        "1",
        "8.0.0",
        J.path + "swf/expressInstall.swf",
        flashvars,
        params,
        attributes
      );
  ...
  switch (soundModeDetector()) {
    case 1: //flash mode
      ...
      J.sound.init = function(option) {
        ...
        var d = $D.node("div", {
          ...
          style:
            "position:absolute;left:0;top:0;width:100px;height:100px;overflow:hidden;" //此处display不能为none, 否则会出现很多诡异的错误
        });
    ...
    case 3: //html5 mode
      ...
      J.sound.init = function() {
        ...
        var d = $D.node("div", {
          id: "sound_object_container",
          style:
            "position:absolute;left:0;top:0;width:1px;height:1px;overflow:hidden;" //此处display不能为none, 否则会出现很多诡异的错误
        });
        (document.body || document.documentElement).appendChild(d);
        J.sound.isReady = true;
      };
    ...
    case 4: //ipad mode
      J.sound = new J.Class(
        J.extend({}, baseSoundPrototype, audioSoundForIpad)
      );
      J.sound.isReady = false;
      /**
       * @ignore
