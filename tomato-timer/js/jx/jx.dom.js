...
Jx().$package(function(J) {
  ...
  var hasClassListProperty =
    document &&
    Object.prototype.hasOwnProperty.call(document.documentElement, "classList");
  ...
  getWin = function(element) {
    ...
    return element.document
      ? element
      : doc["defaultView"] || doc["parentWindow"] || $D.win;
  };
  ...
  getDocHead = function() {
    if (!HeadElement) {
      var doc = getDoc();
      HeadElement = doc.getElementsByTagName("head")
  ...
  J.filename = J.src.replace(/(.*\/){0,}([^\\]+).*/gi, "$2");
